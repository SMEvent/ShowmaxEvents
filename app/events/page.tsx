...
export const metadata: Metadata = {
  ...
  description: "World-class live event production, hybrid events, and virtual event services across Canada. Professional audio (d&b audiotechnik), LED walls (ROE Visual), lighting, and rigging for concerts, conferences, and corporate events in Vancouver, Calgary, Toronto.",
  keywords: [
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Professional event production company providing live, hybrid, and virtual event services across Canada",
        "address": [
          {
            "@type": "PostalAddress",
      ...
      },
      {
        ...
        "areaServed": ["British Columbia", "Alberta", "Ontario"],
